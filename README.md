...
<div align=center>
  <img src=https://github.com/lumahuayuan/SynMars/blob/SynMars-TW/IMG/rover.png width="60%" alt=" (a) Overview of the SynMars-TW dataset. The ten colored lines represent different exploration routes of the rover. (b) Percentage of pixels by category." />
  <br>
</div>
